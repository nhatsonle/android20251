...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Khởi tạo adapter
        //Truyền callback xử lý khi bấm xóa vào adapter
        adapter = StudentAdapter(this, studentList, onDeleteClick = { position ->
    ...
    //Hàm xóa sinh viên (gọi từ adapter)
    ...
    class StudentAdapter(
        ...
        private val onDeleteClick: (Int) -> Unit, //Callback khi bấm xóa
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            // 2. Xử lý click vào toàn bộ dòng (View cha)
